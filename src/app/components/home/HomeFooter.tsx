...
export default function HomeFooter() {
  return (
    <footer className="mx-auto max-w-[1120px] px-5 py-9 font-[family-name:var(--font-ibm-plex-mono)] text-[11px] text-[#7d766a] md:px-7 lg:px-10">
      <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between md:gap-10">
        ...
        {/* Copyright */}
        <span className="whitespace-nowrap">© 2026 KYCombinator</span>
      </div>
