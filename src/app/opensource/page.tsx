  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="prose prose-lg">
        <p className="mb-6">
          KYC is proud to be an open source project. We believe in transparency,
        ...
        <div className="space-y-4">
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <p>
              ...
              for all. Please read and follow our Code of Conduct to help us
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <p>
              ...
              contributing guidelines before submitting pull requests or opening
              issues.
            </p>
          </div>
