...
const Carousel = () => {
  ...
  const slides = [
    { src: "/event-photos/louies/louies1.jpg", alt: "The Louies 2023 Event" },
    { src: "/event-photos/louies/louies2.jpg", alt: "The Louies 2023 Celebration" },
    { src: "/event-photos/louies/louies3.jpg", alt: "The Louies 2023 Awards" },
  ];
