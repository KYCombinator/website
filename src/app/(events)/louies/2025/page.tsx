export default function Louies2025Page() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <section className="relative h-[65vh] bg-[#6B46C1] text-white">
        <div className="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_top,_#E9D8FD,_transparent_60%),radial-gradient(circle_at_bottom,_#B794F4,_transparent_55%)]" />
        <div className="container mx-auto px-4 h-full flex items-center justify-center relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <p className="uppercase tracking-[0.25em] text-xs md:text-sm mb-4 text-purple-100">
                    ...
                    <div className="overflow-x-auto">
                      <table className="min-w-full text-left text-sm">
                        <thead className="bg-gray-50 border-b border-gray-200">
                          <tr>
                            <th className="px-4 py-3 md:px-6 md:py-4 font-semibold text-gray-700 text-xs md:text-sm">
                              Award
                            </th>
                            <th className="px-4 py-3 md:px-6 md:py-4 font-semibold text-gray-700 text-xs md:text-sm">
                              Description
                            </th>
                            <th className="px-4 py-3 md:px-6 md:py-4 font-semibold text-gray-700 text-xs md:text-sm whitespace-nowrap">
                              Presented By
                            </th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-100">
                          {categoryAwards.map((award) => (
                            <tr key={award.name} className="align-top">
                              <td className="px-4 py-4 md:px-6 md:py-5 text-sm font-medium text-gray-900">
                                {award.name}
                              </td>
                              <td className="px-4 py-4 md:px-6 md:py-5 text-xs md:text-sm text-gray-700">
                                {award.description ? (
                                  award.description
                                ) : (
                              ...
                              <td className="px-4 py-4 md:px-6 md:py-5 text-xs md:text-sm text-gray-600 whitespace-nowrap">
                                {award.presentedBy ? (
        ...
        <section className="py-10 md:py-16 bg-gray-50 border-t border-gray-100">
          <div className="container mx-auto px-4">
            <div className="max-w-2xl">
              ...
              <ul className="list-disc list-inside text-sm md:text-base text-gray-600 space-y-1 mb-4">
              ...
              <a
                ...
                className="inline-flex items-center justify-center rounded-full px-5 py-2.5 text-sm font-semibold bg-[#6B46C1] text-white shadow-sm hover:bg-[#5530a6] transition"
              >
                Submit a Nomination
              </a>
