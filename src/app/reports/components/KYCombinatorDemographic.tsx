    ...
    <div className="space-y-8">
      <section>
        ...
        <ul className="list-disc list-inside space-y-2 mb-4">
          <li>
            Nearly twice the size of Nashville (Nashville was 55.7% of
            Louisville)
          </li>
          <li>Larger than Atlanta (Atlanta was 116% of Louisville)</li>
          <li>
            Slightly larger than Indianapolis (Indianapolis was 95.7% of
            Louisville)
          </li>
          <li>
            Almost 4 times larger than Austin (Austin was just 27.8% of
            Louisville)
          </li>
        </ul>
      </section>
