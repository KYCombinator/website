export default function NewYorker() {
  return (
    <div className="space-y-8">
      <section>
        <h2 className="text-2xl font-bold mb-4">The New Yorker: A City in Transition (1974)</h2>
        <p className="mb-4">
      ...
      <section>
        ...
        <div className="space-y-6">
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-semibold mb-4">The Atlanta Comparison</h3>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-semibold mb-4">Economic Identity Crisis</h3>
            <blockquote className="border-l-4 border-gray-300 pl-4 italic">
